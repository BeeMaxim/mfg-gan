...
def start_test(experiment_path, epoch, num_plot_samples, timesteps, plot_window_size, device):
    ...
    # disc_viz = make_dot(discriminator, params=dict(disc_net.named_parameters()))
    # disc_viz.render("discnet_architecture", format="png", cleanup=True)

    # gen_viz = make_dot(generator, params=dict(gen_net.named_parameters()))
    # gen_viz.render("gennet_architecture", format="png", cleanup=True)
    #
    # exit(0)
...
if __name__ == '__main__':
    ...
    experiment_path = './Experiments/Run_2023-09-19__13-43-30__BottleneckCylinderEnv'
    ...
    print(f"epoch={args['epoch']}, num_plot_samples={args['num_plot_samples']},\
